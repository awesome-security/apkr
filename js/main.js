;(function () {
	...
	var downloadAnimate = function() {
		...
		if ( $('#fh5co-download').length > 0 ) {	
			$('#fh5co-download .to-animate').each(function( k ) {
	...
	var downloadWayPoint = function() {
		...
		if ( $('#fh5co-download').length > 0 ) {
			$('#fh5co-download').waypoint( function( direction ) {
	...
	// contribute Us
	var contributeAnimate = function() {

		if ( $('#fh5co-contribute').length > 0 ) {	
			$('#fh5co-contribute .to-animate').each(function( k ) {
	...
	var contributeWayPoint = function() {

		if ( $('#fh5co-contribute').length > 0 ) {
			$('#fh5co-contribute').waypoint( function( direction ) {
										
				if( direction === 'down' && !$(this).hasClass('animated') ) {


					setTimeout(contributeAnimate, 200);
